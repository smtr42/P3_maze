"""This module will contain everything aboutthe position :
...
class Position:
    ...
    def __eq__(self, pos):
        """This will enable the comparison between the attribute position
        of the class Position and other coordinates."""
    ...
    def __iter__(self):
        """So the object returned can be transformed in a tuple or list, it
        must be an iterable."""
